...
export const DB_PATH = process.env.DB_PATH || path.join(__dirname, "mealshare.db");
...
export function seedTestData() {
  ...
  try {
    ...
    insertUserTx([
        ...
        ['Gerardo', 'Obeid', 'gerardo@example.com', passwordHash, 'Passionate about local Mediterranean ingredients and full-stack development.', 'None']
    ]);
    ...
    insertMealTx([
        ...
        [4, 'Traditional Salade Niçoise', 'French', 'A classic, refreshing Mediterranean summer salad featuring fresh tuna, hard-boiled eggs, olives, and anchovies.', 'Tuna, Eggs, Niçoise Olives, Anchovies, Green Beans, Tomatoes, Olive Oil']
    ]);
    ...
    insertEventTx([
        ...
        [3, '2026-06-14 19:00:00', 'Place De Gaulle, Antibes', 5, 5, 18.00, 43.5822, 7.1225],
        [4, '2026-06-28 19:15:00', 'Avenue Robert Soleau, Antibes', 4, 4, 14.00, 43.5835, 7.1248],
        [5, '2026-07-04 19:30:00', 'Port Vauban, Antibes', 8, 8, 25.00, 43.5861, 7.1272],
        [6, '2026-07-12 19:45:00', 'Cap d\'Antibes', 6, 6, 30.00, 43.5539, 7.1283],
        [7, '2026-07-18 12:30:00', 'Boulevard Édouard Baudoin, Juan-les-Pins', 6, 6, 16.50, 43.5685, 7.1122],
        [7, '2026-07-25 20:00:00', 'Pinède Gould, Juan-les-Pins', 8, 8, 19.00, 43.5670, 7.1145]
    ]);
